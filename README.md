# Pose Estimation Heatmap Regression
A model trained on the [MPII Human Pose dataset] (https://drive.google.com/file/d/15b1sRQpKQkC1m28h-v7W3x-rDJBDvf23/view?usp=sharing).
