...
pose_model = tf.keras.models.load_model(r'model/robustloss.h5', custom_objects={'loss': arobust_loss(alpha=1.0, c=1.0, gamma=2.1)})
...
def main(args):
    while True:
        ...
        if args.input == 'image':
            ...
            process_video(pose_model, yolo_model, args.path, 'D:\\Pose Estimation\\Human-Pose-Estimation-master\\videos\\output\\resultvid3.mp4', args.threshold, args.visualization)
